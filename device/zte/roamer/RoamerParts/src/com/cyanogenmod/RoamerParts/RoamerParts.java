package com.cyanogenmod.RoamerParts;

import com.cyanogenmod.RoamerParts.R;
...
public class RoamerParts extends PreferenceActivity {

	@Override
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);

		addPreferencesFromResource(R.xml.roamerparts);
	}
